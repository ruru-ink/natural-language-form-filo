  ...
  NLForm.prototype = {
    _init: function () {
      ...
      Array.prototype.slice
        .call(this.el.querySelectorAll("input" + self.elClass + ':not([type="hidden"]):not([type="submit"])'))
  ...
  NLField.prototype = {
    ...
    _createDropDown: function () {
      ...
      Array.prototype.slice.call(this.elOriginal.querySelectorAll("option")).forEach(function (el, i) {
        ihtml +=
          self.elOriginal.selectedIndex === i ? '<li class="nl-dd-checked">' + el.innerHTML + "</li>" : "<li>" + el.innerHTML + "</li>";
    ...
    _createInput: function () {
      ...
      this.toggle.innerHTML = this.elOriginal.getAttribute("value")
        ? this.elOriginal.getAttribute("value")
        : this.elOriginal.getAttribute("placeholder");
      this.toggle.className = "nl-field-toggle";
      this.optionsList = document.createElement("ul");
    ...
    _initEvents: function () {
      ...
      this.toggle.addEventListener("click", function (ev) {
        ev.preventDefault();
        ev.stopPropagation();
        console.log(`TESTING :: 1 :: this = `, this);
        self._open();
      });
      ...
      if (this.type === "dropdown") {
        ...
        opts.forEach(function (el, i) {
          el.addEventListener("click", function (ev) {
            ev.preventDefault();
            console.log(`TESTING :: 2 :: this = `, this);
        ...
        this.inputsubmit.addEventListener("click", function (ev) {
          ev.preventDefault();
          console.log(`TESTING :: 3 :: this = `, this);
    ...
    close: function (opt, idx, flag) {
      ...
      if (this.type === "dropdown") {
        if (opt) {
          ...
          } else this.elOriginal.fireEvent("change");
        }
      } else if (this.type === "input") {
        this.getinput.blur();
        this.toggle.innerHTML = this.getinput.value.trim() !== "" ? this.getinput.value : this.getinput.getAttribute("placeholder");
        this.elOriginal.value = this.getinput.value;
        this.elOriginal.dispatchEvent(new Event("change"));
      }
    },
  };
